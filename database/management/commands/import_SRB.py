from database.models.GradeInformation import 成績_成績レース情報
from database.management.import_BaseCommand import Command

class Command(Command):
    help = 'command to import SRB(成績_成績レース情報) files'
    file_format = './database/temp/SRB{date}.txt'
    def __init__(self):
        self.__model = 成績_成績レース情報
