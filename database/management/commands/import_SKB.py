from database.models.GradeInformation import 成績_成績分析用拡張情報
from database.management.import_BaseCommand import Command

class Command(Command):
    help = 'command to import SKB(成績_成績分析用拡張情報) files'
    file_format = './database/temp/SKB{date}.txt'
    def __init__(self):
        self.__model = 成績_成績分析用拡張情報
