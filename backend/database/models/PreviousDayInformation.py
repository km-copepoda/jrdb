...
class 前日_競走馬拡張(models.Model):
    ...
    R = models.CharField(max_length=2)
    馬番 = models.CharField(max_length=2)
    JRA成績_1着 = models.CharField(max_length=3)
    JRA成績_2着 = models.CharField(max_length=3)
    JRA成績_3着 = models.CharField(max_length=3)
    JRA成績_着外 = models.CharField(max_length=3)
    交流成績_1着 = models.CharField(max_length=3)
    交流成績_2着 = models.CharField(max_length=3)
    交流成績_3着 = models.CharField(max_length=3)
    交流成績_着外 = models.CharField(max_length=3)
    他成績_1着 = models.CharField(max_length=3)
    他成績_2着 = models.CharField(max_length=3)
    他成績_3着 = models.CharField(max_length=3)
    他成績_着外 = models.CharField(max_length=3)
    芝ダ障害別成績_1着 = models.CharField(max_length=3)
    芝ダ障害別成績_2着 = models.CharField(max_length=3)
    芝ダ障害別成績_3着 = models.CharField(max_length=3)
    芝ダ障害別成績_着外 = models.CharField(max_length=3)
    芝ダ障害別距離成績_1着 = models.CharField(max_length=3)
    芝ダ障害別距離成績_2着 = models.CharField(max_length=3)
    芝ダ障害別距離成績_3着 = models.CharField(max_length=3)
    芝ダ障害別距離成績_着外 = models.CharField(max_length=3)
    トラック距離成績_1着 = models.CharField(max_length=3)
    トラック距離成績_2着 = models.CharField(max_length=3)
    トラック距離成績_3着 = models.CharField(max_length=3)
    トラック距離成績_着外 = models.CharField(max_length=3)
    ローテ成績_1着 = models.CharField(max_length=3)
    ローテ成績_2着 = models.CharField(max_length=3)
    ローテ成績_3着 = models.CharField(max_length=3)
    ローテ成績_着外 = models.CharField(max_length=3)
    回り成績_1着 = models.CharField(max_length=3)
    回り成績_2着 = models.CharField(max_length=3)
    回り成績_3着 = models.CharField(max_length=3)
    回り成績_着外 = models.CharField(max_length=3)
    騎手成績_1着 = models.CharField(max_length=3)
    騎手成績_2着 = models.CharField(max_length=3)
    騎手成績_3着 = models.CharField(max_length=3)
    騎手成績_着外 = models.CharField(max_length=3)
    良成績_1着 = models.CharField(max_length=3)
    良成績_2着 = models.CharField(max_length=3)
    良成績_3着 = models.CharField(max_length=3)
    良成績_着外 = models.CharField(max_length=3)
    稍成績_1着 = models.CharField(max_length=3)
    稍成績_2着 = models.CharField(max_length=3)
    稍成績_3着 = models.CharField(max_length=3)
    稍成績_着外 = models.CharField(max_length=3)
    重成績_1着 = models.CharField(max_length=3)
    重成績_2着 = models.CharField(max_length=3)
    重成績_3着 = models.CharField(max_length=3)
    重成績_着外 = models.CharField(max_length=3)
    Sペース成績_1着 = models.CharField(max_length=3)
    Sペース成績_2着 = models.CharField(max_length=3)
    Sペース成績_3着 = models.CharField(max_length=3)
    Sペース成績_着外 = models.CharField(max_length=3)
    Mペース成績_1着 = models.CharField(max_length=3)
    Mペース成績_2着 = models.CharField(max_length=3)
    Mペース成績_3着 = models.CharField(max_length=3)
    Mペース成績_着外 = models.CharField(max_length=3)
    Hペース成績_1着 = models.CharField(max_length=3)
    Hペース成績_2着 = models.CharField(max_length=3)
    Hペース成績_3着 = models.CharField(max_length=3)
    Hペース成績_着外 = models.CharField(max_length=3)
    季節成績_1着 = models.CharField(max_length=3)
    季節成績_2着 = models.CharField(max_length=3)
    季節成績_3着 = models.CharField(max_length=3)
    季節成績_着外 = models.CharField(max_length=3)
    枠成績_1着 = models.CharField(max_length=3)
    枠成績_2着 = models.CharField(max_length=3)
    枠成績_3着 = models.CharField(max_length=3)
    枠成績_着外 = models.CharField(max_length=3)
    騎手距離成績_1着 = models.CharField(max_length=3)
    騎手距離成績_2着 = models.CharField(max_length=3)
    騎手距離成績_3着 = models.CharField(max_length=3)
    騎手距離成績_着外 = models.CharField(max_length=3)
    騎手トラック距離成績_1着 = models.CharField(max_length=3)
    騎手トラック距離成績_2着 = models.CharField(max_length=3)
    騎手トラック距離成績_3着 = models.CharField(max_length=3)
    騎手トラック距離成績_着外 = models.CharField(max_length=3)
    騎手調教師別成績_1着 = models.CharField(max_length=3)
    騎手調教師別成績_2着 = models.CharField(max_length=3)
    騎手調教師別成績_3着 = models.CharField(max_length=3)
    騎手調教師別成績_着外 = models.CharField(max_length=3)
    騎手馬主別成績_1着 = models.CharField(max_length=3)
    騎手馬主別成績_2着 = models.CharField(max_length=3)
    騎手馬主別成績_3着 = models.CharField(max_length=3)
    騎手馬主別成績_着外 = models.CharField(max_length=3)
    騎手ブリンカ成績_1着 = models.CharField(max_length=3)
    騎手ブリンカ成績_2着 = models.CharField(max_length=3)
    騎手ブリンカ成績_3着 = models.CharField(max_length=3)
    騎手ブリンカ成績_着外 = models.CharField(max_length=3)
    調教師馬主別成績_1着 = models.CharField(max_length=3)
    調教師馬主別成績_2着 = models.CharField(max_length=3)
    調教師馬主別成績_3着 = models.CharField(max_length=3)
    調教師馬主別成績_着外 = models.CharField(max_length=3)
