...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "性別コード",
                    models.CharField(
                        choices=[("1", "牡"), ("2", "牝"), ("3", "セン")], max_length=1
                    ),
                ),
        ...
        migrations.AddIndex(
            model_name="前日_番組情報",
            index=models.Index(
                fields=["前日_開催情報"], name="前日_番組情報-前日_開催情報_IDX"
            ),
        ),
        migrations.AddIndex(
            model_name="前日_競走馬情報",
            index=models.Index(
                fields=["前日_開催情報"], name="前日_競走馬情報-前日_開催情報_IDX"
            ),
        ),
        migrations.AddIndex(
            model_name="前日_競走馬情報",
            index=models.Index(
                fields=["前日_番組情報"], name="前日_競走馬情報-前日_番組情報_IDX"
            ),
        ),
        migrations.AddIndex(
            model_name="前日_競走馬情報",
            index=models.Index(
                fields=["馬基本情報"], name="前日_競走馬情報-馬基本情報_IDX"
            ),
        ),
        migrations.AddIndex(
            model_name="前日_競走馬情報",
            index=models.Index(
                fields=["マスタ_騎手データ"],
                name="前日_競走馬情報-マスタ_騎手データ_IDX",
            ),
        ),
        migrations.AddIndex(
            model_name="前日_競走馬情報",
            index=models.Index(
                fields=["前日_調教師情報"], name="前日_競走馬情報-前日_調教師情報_IDX"
            ),
        ),
        migrations.AddIndex(
            model_name="前日_基本馬単情報",
            index=models.Index(
                fields=["前日_開催情報"], name="前日_基本馬単情報-前日_開催情報_IDX"
            ),
        ),
        migrations.AddIndex(
            model_name="前日_基本馬単情報",
            index=models.Index(
                fields=["前日_番組情報"], name="前日_基本馬単情報-前日_番組情報_IDX"
            ),
        ),
        migrations.AddIndex(
            model_name="前日_基準ワイド情報",
            index=models.Index(
                fields=["前日_開催情報"], name="前日_基準ワイド情報-前日_開催情報_IDX"
            ),
        ),
        migrations.AddIndex(
            model_name="前日_基準ワイド情報",
            index=models.Index(
                fields=["前日_番組情報"], name="前日_基準ワイド情報-前日_番組情報_IDX"
            ),
        ),
        migrations.AddIndex(
            model_name="前日_基準三連単情報",
            index=models.Index(
                fields=["前日_開催情報"], name="前日_基準三連単情報-前日_開催情報_IDX"
            ),
        ),
        migrations.AddIndex(
            model_name="前日_基準三連単情報",
            index=models.Index(
                fields=["前日_番組情報"], name="前日_基準三連単情報-前日_番組情報_IDX"
            ),
        ),
        migrations.AddIndex(
            model_name="前日_基準三連複情報",
            index=models.Index(
                fields=["前日_開催情報"], name="前日_基本三連複情報-前日_開催情報_IDX"
            ),
        ),
        migrations.AddIndex(
            model_name="前日_基準三連複情報",
            index=models.Index(
                fields=["前日_番組情報"], name="前日_基本三連複情報-前日_番組情報_IDX"
            ),
        ),
        migrations.AddIndex(
            model_name="前日_基準単複連情報",
            index=models.Index(
                fields=["前日_開催情報"], name="前日_基本単複連情報-前日_開催情報_IDX"
            ),
        ),
        migrations.AddIndex(
            model_name="前日_基準単複連情報",
            index=models.Index(
                fields=["前日_番組情報"], name="前日_基本単複連情報-前日_番組情報_IDX"
            ),
        ),
        migrations.AddIndex(
            model_name="成績_成績レース情報",
            index=models.Index(
                fields=["前日_開催情報"], name="成績_成績レース情報-前日_開催情報_IDX"
            ),
        ),
        migrations.AddIndex(
            model_name="成績_成績レース情報",
            index=models.Index(
                fields=["前日_番組情報"], name="成績_成績レース情報-前日_番組情報_IDX"
            ),
        ),
        migrations.AddIndex(
            model_name="成績_払戻情報",
            index=models.Index(
                fields=["前日_開催情報"], name="成績_払戻情報-前日_開催情報_IDX"
            ),
        ),
        migrations.AddIndex(
            model_name="成績_払戻情報",
            index=models.Index(
                fields=["前日_番組情報"], name="成績_払戻情報-前日_番組情報_IDX"
            ),
        ),
        migrations.AddIndex(
            model_name="前日_競走馬拡張",
            index=models.Index(
                fields=["前日_開催情報"], name="前日_競走馬拡張-前日_開催情報_IDX"
            ),
        ),
        migrations.AddIndex(
            model_name="前日_競走馬拡張",
            index=models.Index(
                fields=["前日_番組情報"], name="前日_競走馬拡張-前日_番組情報_IDX"
            ),
        ),
        migrations.AddIndex(
            model_name="前日_競走馬拡張",
            index=models.Index(
                fields=["前日_競走馬情報"], name="前日_競走馬拡張-前日_競走馬情報_IDX"
            ),
        ),
        migrations.AddIndex(
            model_name="前日_詳細情報",
            index=models.Index(
                fields=["前日_開催情報"], name="前日_詳細情報-前日_開催情報_IDX"
            ),
        ),
        migrations.AddIndex(
            model_name="前日_詳細情報",
            index=models.Index(
                fields=["前日_番組情報"], name="前日_詳細情報-前日_番組情報_IDX"
            ),
        ),
        migrations.AddIndex(
            model_name="前日_詳細情報",
            index=models.Index(
                fields=["前日_競走馬情報"], name="前日_詳細情報-前日_競走馬情報_IDX"
            ),
        ),
        migrations.AddIndex(
            model_name="前日_詳細情報",
            index=models.Index(
                fields=["馬基本情報"], name="前日_詳細情報-馬基本情報_IDX"
            ),
        ),
        migrations.AddIndex(
            model_name="前日_調教分析情報",
            index=models.Index(
                fields=["前日_開催情報"], name="前日_調教分析情報-前日_開催情報_IDX"
            ),
        ),
        migrations.AddIndex(
            model_name="前日_調教分析情報",
            index=models.Index(
                fields=["前日_番組情報"], name="前日_調教分析情報-前日_番組情報_IDX"
            ),
        ),
        migrations.AddIndex(
            model_name="前日_調教分析情報",
            index=models.Index(
                fields=["前日_競走馬情報"], name="前日_調教分析情報-前日_競走馬情報_IDX"
            ),
        ),
        migrations.AddIndex(
            model_name="前日_調教本追切情報",
            index=models.Index(
                fields=["前日_開催情報"], name="前日_調教本追切情報-前日_開催情報_IDX"
            ),
        ),
        migrations.AddIndex(
            model_name="前日_調教本追切情報",
            index=models.Index(
                fields=["前日_番組情報"], name="前日_調教本追切情報-前日_番組情報_IDX"
            ),
        ),
        migrations.AddIndex(
            model_name="前日_調教本追切情報",
            index=models.Index(
                fields=["前日_競走馬情報"],
                name="前日_調教本追切情報-前日_競走馬情報_IDX",
            ),
        ),
        migrations.AddIndex(
            model_name="成績_成績分析用情報",
            index=models.Index(
                fields=["前日_開催情報"], name="成績_成績分析用情報-前日_開催情報_IDX"
            ),
        ),
        migrations.AddIndex(
            model_name="成績_成績分析用情報",
            index=models.Index(
                fields=["前日_番組情報"], name="成績_成績分析用情報-前日_番組情報_IDX"
            ),
        ),
        migrations.AddIndex(
            model_name="成績_成績分析用情報",
            index=models.Index(
                fields=["前日_競走馬情報"],
                name="成績_成績分析用情報-前日_競走馬情報_IDX",
            ),
        ),
        migrations.AddIndex(
            model_name="成績_成績分析用情報",
            index=models.Index(
                fields=["馬基本情報"], name="成績_成績分析用情報-馬基本情報_IDX"
            ),
        ),
        migrations.AddIndex(
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["前日_競走馬情報"],
                name="成績_成績分析用拡張情報-前日_競走馬情報_IDX",
            ),
        ),
        migrations.AddIndex(
            model_name="成績_成績分析用拡張情報",
            index=models.Index(
                fields=["馬基本情報"], name="成績_成績分析用拡張情報-馬基本情報_IDX"
            ),
        ),
    ]
