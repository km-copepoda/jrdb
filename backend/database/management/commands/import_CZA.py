from database.models.PreviousDayInformation import 前日_調教師情報
from database.management.import_BaseCommand import Command

class Command(Command):
    help = 'command to import CZA(前日_調教師情報) files'
    file_format = './database/temp/CZA{date}.txt'
    def __init__(self):
        self.__model = 前日_調教師情報
