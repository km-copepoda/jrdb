from database.models.PreviousDayInformation import 前日_基本馬単情報
from database.management.import_BaseCommand import Command

class Command(Command):
    help = 'command to import OU(前日_基本馬単情報) files'
    file_format = './database/temp/OU{date}.txt'
    def __init__(self):
        self.__model = 前日_基本馬単情報
