from database.models.PreviousDayInformation import 前日_基準三連単情報
from database.management.import_BaseCommand import Command

class Command(Command):
    help = 'command to import OV(前日_基準三連単情報) files'
    file_format = './database/temp/OV{date}.txt'
    def __init__(self):
        self.__model = 前日_基準三連単情報
