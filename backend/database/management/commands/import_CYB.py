from database.models.PreviousDayInformation import 前日_調教分析情報
from database.management.import_BaseCommand import Command

class Command(Command):
    help = 'command to import CYB(前日_調教分析情報) files'
    file_format = './database/temp/CYB{date}.txt'
    def __init__(self):
        self.__model = 前日_調教分析情報
