from database.models.PreviousDayInformation import 前日_詳細情報
from database.management.import_BaseCommand import Command

class Command(Command):
    help = 'command to import JOA(前日_詳細情報) files'
    file_format = './database/temp/JOA{date}.txt'
    def __init__(self):
        self.__model = 前日_詳細情報
