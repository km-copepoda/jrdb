"""
Django settings for jrdb project.
...
SECRET_KEY = '6vau_ej8p8-=7!t7hd!f1x(g=&ahz9gc(7-5jd0eat0ds(4qqd'
...
WSGI_APPLICATION = 'jrdb.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DB_NAME', 'jrdb'),
